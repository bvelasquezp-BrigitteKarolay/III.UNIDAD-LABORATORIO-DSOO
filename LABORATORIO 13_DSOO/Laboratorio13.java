...
class GameModel implements Serializable {
    ...
    // Constructor: inicializa tablero y coloca soldados
    public GameModel() {
        for (int r = 0; r < 10; r++) {
            for (int c = 0; c < 10; c++) {
                board[r][c] = "";
    ...
    public String generarTextoConsola() {
        ...
        sb.append("Cantidad total de soldados creados: ").append(total1).append("\n");
        ...
        sb.append("Cantidad total de soldados creados: ").append(total2).append("\n");
        ...
        sb.append("Ejercito 1: ").append(reino1)
                .append(": ").append(vida1).append("  ")
                .append(String.format("%.2f", prob1)).append("% de probabilidad de victoria\n");

        sb.append("Ejercito 2: ").append(reino2)
                .append(": ").append(vida2).append("  ")
                .append(String.format("%.2f", prob2)).append("% de probabilidad de victoria\n\n");

        sb.append("El ganador es el ejercito ").append(ganador.equals(reino1) ? "1" : "2")
                .append(" de: ").append(ganador)
                .append(". Ya que al generar los porcentajes de probabilidad de victoria basada en los niveles de vida ")
                .append("de sus soldados y aplicando un experimento aleatorio salió vencedor. ")
                .append("(Aleatorio generado: ").append(String.format("%.2f", aleatorio)).append(")");

        return sb.toString();
    }

    // ranking y config en texto
...
class GameView extends JFrame {
    ...
    public GameView() {
        setTitle("Laboratorio 13 - GUI Avanzada");
        setSize(1100, 780);
    ...
    private void crearTablero() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            // alternancion de colores (crema / dorado)
